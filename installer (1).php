...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210927_betandyoucom_016bcd6e555422d29212_20211006123035_archive.zip';
	const ARCHIVE_SIZE		 = '48102338';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '016bcd6-06123035';
    const SECONDARY_PACKAGE_HASH = '7a0fbd5-06123035';
	const VERSION			 = '1.4.3';
